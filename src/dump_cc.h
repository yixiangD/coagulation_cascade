...
class DumpCC : public Dump {
 public:
  DumpCC(class LAMMPS *, int, char **);
  ~DumpCC();
  void init();
  double memory_usage();
 ...
 private:
  ...
  typedef void (DumpCC::*FnPtrHeader)(int);
  FnPtrHeader header_choice;           // ptr to write header functions
  void header_binary(int);
  void header_item(int);

  typedef void (DumpCC::*FnPtrData)(int, double *);
  ...
  typedef void (DumpCC::*FnPtrPack)(int);
