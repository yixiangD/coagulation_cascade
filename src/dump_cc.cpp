...
DumpCC::DumpCC(LAMMPS *lmp, int narg, char **arg) :
  Dump(lmp, narg, arg)
{
...
void DumpCC::init()
{
  ...
  if (binary) header_choice = &DumpCC::header_binary;
  else header_choice = &DumpCC::header_item;

  if (binary) write_choice = &DumpCC::write_binary;
  else write_choice = &DumpCC::write_text;
...
void DumpCC::write_header(int ndump)
{
...
void DumpCC::header_binary(int ndump)
{
...
void DumpCC::header_item(int ndump)
{
...
void DumpCC::write_data(int n, double *buf)
{
...
void DumpCC::write_binary(int n, double *buf)
{
  n *= size_one;
...
void DumpCC::write_text(int n, double *buf)
{
  int i,j;
...
void DumpCC::parse_fields(int narg, char **arg)
{
  // customize by adding to if statement
  ...
  for (int iarg = 5; iarg < narg; iarg++) {
    ...
    if (strcmp(arg[iarg],"id") == 0) {
      pack_choice[i] = &DumpCC::pack_id;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"mol") == 0) {
      if (!atom->molecule_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_molecule;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"type") == 0) {
      pack_choice[i] = &DumpCC::pack_type;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"mass") == 0) {
      pack_choice[i] = &DumpCC::pack_mass;
      vtype[i] = DOUBLE;

    } else if (strcmp(arg[iarg],"T1") == 0) {
        pack_choice[i] = &DumpCC::pack_T1;
        vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"T2") == 0) {
        pack_choice[i] = &DumpCC::pack_T2;
        vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"T3") == 0) {
        pack_choice[i] = &DumpCC::pack_T3;
        vtype[i] = DOUBLE;

    } else if (strcmp(arg[iarg],"x") == 0) {
      pack_choice[i] = &DumpCC::pack_x;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"y") == 0) {
      pack_choice[i] = &DumpCC::pack_y;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"z") == 0) {
      pack_choice[i] = &DumpCC::pack_z;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"xs") == 0) {
      if (domain->triclinic)
	error->all("Cannot dump scaled coords with triclinic box");
      pack_choice[i] = &DumpCC::pack_xs;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"ys") == 0) {
      if (domain->triclinic)
	error->all("Cannot dump scaled coords with triclinic box");
      pack_choice[i] = &DumpCC::pack_ys;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"zs") == 0) {
      if (domain->triclinic)
	error->all("Cannot dump scaled coords with triclinic box");
      pack_choice[i] = &DumpCC::pack_zs;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"xu") == 0) {
      pack_choice[i] = &DumpCC::pack_xu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"yu") == 0) {
      pack_choice[i] = &DumpCC::pack_yu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"zu") == 0) {
      pack_choice[i] = &DumpCC::pack_zu;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"ix") == 0) {
      pack_choice[i] = &DumpCC::pack_ix;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"iy") == 0) {
      pack_choice[i] = &DumpCC::pack_iy;
      vtype[i] = INT;
    } else if (strcmp(arg[iarg],"iz") == 0) {
      pack_choice[i] = &DumpCC::pack_iz;
      vtype[i] = INT;

    } else if (strcmp(arg[iarg],"vx") == 0) {
      pack_choice[i] = &DumpCC::pack_vx;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vy") == 0) {
      pack_choice[i] = &DumpCC::pack_vy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"vz") == 0) {
      pack_choice[i] = &DumpCC::pack_vz;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fx") == 0) {
      pack_choice[i] = &DumpCC::pack_fx;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fy") == 0) {
      pack_choice[i] = &DumpCC::pack_fy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"fz") == 0) {
      pack_choice[i] = &DumpCC::pack_fz;
      vtype[i] = DOUBLE;

    } else if (strcmp(arg[iarg],"q") == 0) {
      if (!atom->q_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_q;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"mux") == 0) {
      if (!atom->mu_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_mux;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"muy") == 0) {
      if (!atom->mu_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_muy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"muz") == 0) {
      if (!atom->mu_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_muz;
      vtype[i] = DOUBLE;

    } else if (strcmp(arg[iarg],"radius") == 0) {
      if (!atom->radius_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_radius;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"omegax") == 0) {
      if (!atom->omega_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_omegax;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"omegay") == 0) {
      if (!atom->omega_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_omegay;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"omegaz") == 0) {
      if (!atom->omega_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_omegaz;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"angmomx") == 0) {
      if (!atom->angmom_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_angmomx;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"angmomy") == 0) {
      if (!atom->angmom_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_angmomy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"angmomz") == 0) {
      if (!atom->angmom_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_angmomz;
      vtype[i] = DOUBLE;

    } else if (strcmp(arg[iarg],"quatw") == 0) {
      if (!atom->quat_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_quatw;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"quati") == 0) {
      if (!atom->quat_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_quati;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"quatj") == 0) {
      if (!atom->quat_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_quatj;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"quatk") == 0) {
      if (!atom->quat_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_quatk;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"tqx") == 0) {
      if (!atom->torque_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_tqx;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"tqy") == 0) {
      if (!atom->torque_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_tqy;
      vtype[i] = DOUBLE;
    } else if (strcmp(arg[iarg],"tqz") == 0) {
      if (!atom->torque_flag)
	error->all("Dumping an atom quantity that isn't allocated");
      pack_choice[i] = &DumpCC::pack_tqz;
      vtype[i] = DOUBLE;
    ...
    // if no trailing [], then arg is set to 0, else arg is between []
      ...
      pack_choice[i] = &DumpCC::pack_compute;
      vtype[i] = DOUBLE;
	...
	*ptr = '\0';
    ...
    // variable value = v_name
      ...
      pack_choice[i] = &DumpCC::pack_variable;
      vtype[i] = DOUBLE;
...
int DumpCC::add_compute(char *id)
{
  int icompute;
...
int DumpCC::add_variable(char *id)
{
  int ivariable;
...
int DumpCC::modify_param(int narg, char **arg)
{
  if (strcmp(arg[0],"region") == 0) {
    ...
    else if (strcmp(arg[1],"T1") == 0) thresh_array[nthresh] = VX;
    else if (strcmp(arg[1],"T2") == 0) thresh_array[nthresh] = VY;
    else if (strcmp(arg[1],"T3") == 0) thresh_array[nthresh] = VZ;
...
void DumpCC::pack_compute(int n)
{
...
void DumpCC::pack_variable(int n)
{
...
void DumpCC::pack_molecule(int n)
{
  int *molecule = atom->molecule;
  int nlocal = atom->nlocal;
...
void DumpCC::pack_angmomx(int n)
{
...
void DumpCC::pack_angmomy(int n)
{
  double **angmom = atom->angmom;
  int nlocal = atom->nlocal;
...
void DumpCC::pack_angmomz(int n)
{
  double **angmom = atom->angmom;
  int nlocal = atom->nlocal;
