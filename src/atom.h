...
class Atom : protected Pointers {
 public:
  ...
  int n_mol;                    //total number of  molecules
  int *atoms_in_mol;            //number of atoms in molecules
  ...
  int *molecule;
  int *bond_danger;  // by Huan Lei, a tag to see if the bond length is too long for WLC bond
	double *mol_tact;   // Alireza: time of activation of molecules
  double *q,**mu;
